...
async def session_gen(c : asstb, m : Message):
    ...
    API_ID = await c.ask(m.chat.id, "**Send your API_ID**\n/cancel - cancel current process")
    ...
    API_HASH = await c.ask(m.chat.id, "**Now send your API_HASH**\n/cancel - cancel current process")
    ...
    PHONE_NUMBER = await c.ask(m.chat.id, "**Enter your phone number with country code**\n`Example : +91 9101069695`\n/cancel - cancel current process")
    ...
    try:
        ...
        phone_code_msg = await c.ask(m.chat.id, "**Send OTP in `1 2 3 4 5` format**\n/cancel - cancel current process")
    ...
    try:
        ...
        try:
            two_step_msg = await c.ask(m.chat.id, "**You have two step password enabled Please enter below**\n/cancel - cancel current process")
