...
async def help_cmd(c: asstb, m: Message):
    ...
    if m.chat.type != ChatType.PRIVATE:
        ...
        main_keyboard = ikb([[("PM", f"http://t.me/{BOT_USERNAME}?start=help", "url")]])
        ...
        main_keyboard = ikb(
            [
                [
                    ...
                    ("Alive", "alive_callback"),
                    ("PM Bot", "pmbot_callback"),
                ],
                [
                    ("Session Gen", "session_callback"),
                    ("Spotify Downloader", "spotify_callback"),
...
"""
        keyboard = ikb([[("Back", "back_callback")]])
