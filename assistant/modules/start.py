...
async def start_cmd(c: asstb, m: Message):
    ...
    keyboard = ikb(
        [
            [
                ("Dev", "t.me/minkxx69", "url"),
                ("Github", "https://github.com/minkxx", "url"),
                ("Repo", "https://github.com/AssistantBot", "url"),
            ],
            [
                ("Channel", "https://t.me/MinkxxSays", "url"),
                ("Group", "https://t.me/BotsUnion", "url"),
            ],
        ]
    )
    await c.send_photo(
